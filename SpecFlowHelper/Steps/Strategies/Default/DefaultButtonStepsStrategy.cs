...
namespace SpecFlowHelper.Steps.Strategies.Default
{
    ...
    public class DefaultButtonStepsStrategy : StepsStrategyBase<ButtonSteps>, IButtonStepsStrategy
    {
        ...
        {
            var xpath = "//a[text()='{0}']|//input[@value='{0}' and @type='submit']|//input[@value='{0}' and @type='button']|//button[text()='{0}']|//button[contains(text(),'{0}')]|//button[contains(.,'{0}')]|//span[contains(.,'{0}')]|//a[contains(., '{0}') and contains(@class, 'btn')]".With(label);
